...
public class ItemsBoxProvider extends ContentProvider {

    /**
     * URI matcher code for the content URI for the items table
     */
    private static final int ITEMS_BOX = 100;

    /**
     * URI matcher code for the content URI for a single item in the items table
     */
    private static final int ITEMS_BOX_ID = 101;
    ...
    static {
        ...
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_INVENTORY, ITEMS_BOX);
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_INVENTORY + "/#", ITEMS_BOX_ID);
    }

    /**
     * Tag for the log messages
     */
    public static final String LOG_TAG = ItemsBoxProvider.class.getSimpleName();
